...
public class ChatRoomService {
    ...
    @Transactional
    public ChatRoomDto findRoomByNo(String No){
        ChatRoom chatRoom = chatRoomRepository.findChatRoomByRoomNo(No);
    ...
    public ChatRoomDto findRoomByName(String Name){
        ChatRoom chatRoom = chatRoomRepository.findChatRoomByRoomName(Name);
        ChatRoomDto chatRoomDto = new ChatRoomDto(chatRoom);
